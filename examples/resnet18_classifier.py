...
"""Sample module for using ResNet18 classifier with SNNL"""
import argparse
import torch

from snnl.models.resnet18 import ResNet18
...
def parse_args():
    parser = argparse.ArgumentParser(description="ResNet18 classifier with SNNL")
