...
from snnl.models.resnet34 import ResNet34
...
def parse_args():
    parser = argparse.ArgumentParser(description="ResNet34 classifier with SNNL")
    ...
    group.add_argument(
        ...
        "--configuration",
        required=False,
        default="examples/hyperparameters/resnet34.json",
        type=str,
